        ...
        >
          ...
          >
            ...
            <div className="relative overflow-hidden rounded-[28px] border border-white/10 bg-white/[0.04] p-3 backdrop-blur-2xl shadow-[0_20px_60px_rgba(0,0,0,0.28)]">
              ...
              {/* TOP TAG */}
              <div className="absolute left-7 top-7 rounded-full border border-cyan-300/20 bg-cyan-100/10 px-4 py-2 backdrop-blur-xl shadow-[0_0_20px_rgba(34,211,238,0.12)]">
