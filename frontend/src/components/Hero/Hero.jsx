          ...
          <div className="lg:col-span-7 flex flex-col justify-center space-y-6 md:space-y-7">
            ...
            <Reveal delay={0.45}>
              <div className="flex flex-col sm:flex-row gap-4 pt-2">
                ...
                <MagneticButton
                  href="#projects"
                  className="inline-flex items-center justify-center rounded-full border border-amber-300/30 bg-white/[0.06] px-8 py-4 text-[11px] font-bold uppercase tracking-[0.28em] text-white  transition-all duration-300 hover:bg-indigo-700 w-full sm:w-auto"
                >
