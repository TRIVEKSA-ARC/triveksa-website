...
function Hero() {
  ...
  return (
    <>
      {/* ================= PREMIUM AGENCY HERO ================= */}
      <section className="relative min-h-screen w-full overflow-hidden bg-transparent text-white flex items-center font-sans py-16 sm:py-24 lg:py-32 tracking-[-0.01em]">
        ...
        <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
          ...
          <motion.div 
            ...
            className="absolute -top-[10%] -right-[20%] sm:-top-[20%] sm:-right-[10%] h-[400px] sm:h-[700px] w-[400px] sm:w-[700px] rounded-full bg-amber-500/[0.03] blur-[100px] sm:blur-[150px]"
          />
          <motion.div 
            animate={{ rotate: -360 }}
        ...
        <div className="relative z-10 mx-auto grid w-full max-w-7xl grid-cols-1 gap-10 px-5 sm:px-8 md:px-10 lg:grid-cols-12 lg:gap-8 lg:px-12 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center space-y-6 sm:space-y-8 order-1">
            ...
            <div className="flex flex-col space-y-3 sm:space-y-4">
              ...
              <Reveal>
                <div className="flex items-center gap-3 sm:gap-4">
                  ...
                  <p className="text-[9px] sm:text-[12px] uppercase tracking-[0.3em] sm:tracking-[0.42em] text-[#D4AF37] font-bold drop-shadow-md leading-relaxed">
            ...
            <Reveal delay={0.12}>
              <div className="flex flex-col space-y-1.5 border-l-2 border-amber-400/40 pl-3 sm:pl-4 py-0.5 order-3">
                <span className="text-[11px] sm:text-[15px] uppercase tracking-[0.15em] sm:tracking-[0.22em] text-[#FFFFFF] font-bold leading-snug">
                  Full Stack Developer • UI/UX Designer • Creative Technologist
                </span>
                <span className="text-[10px] sm:text-[12px] uppercase tracking-[0.2em] sm:tracking-[0.3em] text-[#D6D9E0] font-medium">
            ...
            <Reveal delay={0.24}>
              <div className="flex flex-wrap gap-2 order-5">
                {["MERN Stack", "Responsive Design", "UI/UX Systems", "Video Editing", "Branding"].map((chip) => (
                  <span 
                    key={chip}
                    className="inline-flex items-center gap-1.5 rounded-full border border-white/10 bg-white/[0.02] backdrop-blur-md px-3 py-1.5 text-[9px] sm:text-[11px] uppercase tracking-[0.15em] sm:tracking-[0.2em] text-[#D6D9E0] font-medium"
                  >
            ...
            <Reveal delay={0.3}>
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 max-w-xl order-6">
                {stats.map((stat, idx) => (
                  <div key={idx} className="border border-white/5 bg-white/[0.01] backdrop-blur-xl rounded-xl p-3 sm:p-4 text-center">
                    <div className="text-xl sm:text-3xl font-black text-white">{stat.value}</div>
                    <div className="text-[8px] sm:text-[10px] uppercase tracking-[0.2em] text-zinc-400 mt-0.5 font-semibold">{stat.label}</div>
                  </div>
                ))}
              </div>
            </Reveal>
            ...
            <Reveal delay={0.36}>
              <div className="flex flex-col space-y-3 pt-1 order-7">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <MagneticButton
                    href="#contact"
                    className="inline-flex items-center justify-center gap-2.5 rounded-full border border-white bg-gradient-to-r from-[#f8d36a] to-[#d89b1d] px-6 py-3.5 text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.2em] sm:tracking-[0.28em] text-black shadow-lg w-full sm:w-auto"
                  >
                    <Rocket size={13} />
                    Book Discovery Call
                  </MagneticButton>
                  ...
                  <MagneticButton
                    href="#projects"
                    className="inline-flex items-center justify-center gap-2.5 rounded-full border border-white/10 bg-white/[0.04] backdrop-blur-md px-6 py-3.5 text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.2em] sm:tracking-[0.28em] text-white w-full sm:w-auto"
                  >
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <MagneticButton
                    href="/portfolio.pdf"
                    download
                    className="inline-flex items-center justify-center gap-2.5 rounded-full border border-white/10 bg-white/[0.04] backdrop-blur-md px-6 py-3.5 text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.2em] sm:tracking-[0.28em] text-[#D6D9E0] w-full sm:w-auto"
                  >
                    <Download size={13} />
                    Download Portfolio
                  </MagneticButton>
            ...
            <Reveal delay={0.42}>
              <div className="flex items-center justify-center sm:justify-start gap-3.5 pt-1 order-8">
                {[
                  { icon: <Github size={15} />, url: "https://github.com" },
                  { icon: <Linkedin size={15} />, url: "https://linkedin.com" },
                  { icon: <Instagram size={15} />, url: "https://instagram.com" },
                  { icon: <Youtube size={15} />, url: "https://youtube.com" }
                ].map((social, idx) => (
                  <motion.a
                    key={idx}
                    href={social.url}
                    ...
                    className="h-9 w-9 flex items-center justify-center rounded-full border border-white/10 bg-white/[0.02] backdrop-blur-xl text-zinc-400 hover:text-amber-400 hover:border-amber-400/40 shadow-sm transition-all duration-300"
                  >
                    {social.icon}
                  </motion.a>
                ))}
            ...
            <Reveal delay={0.48}>
              <div className="pt-5 border-t border-white/5 max-w-2xl overflow-hidden w-full relative order-9">
                <div className="absolute right-0 top-0 bottom-0 w-8 bg-gradient-to-l from-black to-transparent z-10 pointer-events-none" />
                <div className="absolute left-0 top-0 bottom-0 w-8 bg-gradient-to-r from-black to-transparent z-10 pointer-events-none" />
                <motion.div 
                  animate={{ x: [0, -800] }}
                  transition={{ ease: "linear", duration: 20, repeat: Infinity }}
                  className="flex gap-6 whitespace-nowrap text-[9px] sm:text-[11px] uppercase tracking-[0.25em] text-zinc-500 font-bold"
                >
          ...
          {/* DESKTOP EXCLUSIVE LAYOUT MATRIX — PREVENTS RENDER DOUBLE FLUIDITY */}
          <div className="hidden lg:col-span-5 lg:flex justify-center lg:justify-end items-center w-full order-2">
            <Reveal delay={0.25} className="w-full flex justify-center lg:justify-end">
              <div className="group relative w-full max-w-[440px]">
                ...
                <div className="relative aspect-[4/5] w-full overflow-hidden rounded-3xl border border-white/10 bg-neutral-950/40 p-2.5 backdrop-blur-3xl transition-all duration-700 group-hover:border-amber-400/40 group-hover:shadow-[0_30px_80px_rgba(216,155,29,0.12)]">
                  ...
                  <div className="absolute bottom-5 left-5 right-5 flex flex-col bg-slate-900/90 p-4 rounded-xl border border-white/20 shadow-2xl backdrop-blur-2xl z-20 space-y-3">
                    <div>
        ...
        <div className="absolute bottom-4 sm:bottom-6 left-1/2 -translate-x-1/2 flex flex-col items-center space-y-1 opacity-30 pointer-events-none z-10">
