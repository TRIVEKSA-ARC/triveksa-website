          ...
          <form className="space-y-5">
            <div className="grid md:grid-cols-2 gap-5">
              <input
                ...
                className="w-full rounded-xl border border-white/10 bg-white/[0.03] px-4 py-4 text-white outline-none focus:border-amber-400"
              />
            ...
            <div className="grid md:grid-cols-2 gap-5">
              ...
              <select
                className="w-full rounded-xl border border-white/10 bg-[#111111] px-4 py-4 text-white outline-none focus:border-amber-400"
              >
            ...
            <textarea
              ...
              className="w-full rounded-xl border border-white/10 bg-white/[0.03] px-4 py-4 text-white outline-none focus:border-amber-400 resize-none"
            />

            <button
              type="submit"
              className="w-full rounded-full bg-gradient-to-r from-[#f5c96a] to-[#d89b1d] px-8 py-4 font-bold uppercase tracking-[0.2em] text-black transition hover:scale-[1.01]"
            >
              Start Your Project
            </button>
          </form>
