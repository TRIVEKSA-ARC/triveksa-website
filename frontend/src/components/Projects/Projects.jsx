        ...
        >
          {items.map((item) => (
            ...
            >
              ...
              <div className="relative h-[58%] w-full bg-transparent  rounded-[20px] border border-white/5 p-2 flex items-center justify-center overflow-hidden transition duration-500 group-hover:border-white/15">
