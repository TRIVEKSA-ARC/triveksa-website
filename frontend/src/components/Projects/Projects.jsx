        ...
        >
          {items.map((item) => (
            ...
            >
              ...
              <div className="relative h-[58%] w-full bg-[#f6f6f6] rounded-[20px] border border-white/5 p-3 flex items-center justify-center overflow-hidden transition duration-500 group-hover:border-white/15">
