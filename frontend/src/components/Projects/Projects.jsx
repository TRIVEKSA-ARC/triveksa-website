          ...
          {items.map((item) => (
            ...
            >
              ...
              <div className="absolute inset-x-0 bottom-0 z-10 p-5 md:p-6">
                <div className="rounded-[22px] border border-white/15 bg-black/[0.30] p-5 backdrop-blur-[10px] shadow-[0_10px_30px_rgba(0,0,0,0.18)] transition duration-500 group-hover:bg-white/[0.14]">
